...
class Radar_24G extends ZigBeeDevice {
  /**
   ...
   */
  async onAdded() {
    this.log("Radar 24G has been added");
  }
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    this.log("Radar 24G settings where changed");
  }
  ...
  async onRenamed(name) {
    this.log("Radar 24G was renamed");
  }
   ...
   */
  async onDeleted() {
    this.log("Radar 24G has been deleted");
  }
}

module.exports = Radar_24G;
