...
class soilMoistureSensorGen2 extends ZigBeeDevice {
  ...
  async configAttributeReport() {
    ...
    await this.zclNode.endpoints[1].clusters[CLUSTER.TEMPERATURE_MEASUREMENT.NAME].configureReporting({
      batteryPercentageRemaining: {
        minInterval: 5,
        maxInterval: 36000,
        minChange: 100
    ...
    await this.zclNode.endpoints[1].clusters[CLUSTER.RELATIVE_HUMIDITY_MEASUREMENT.NAME].configureReporting({
      batteryPercentageRemaining: {
        minInterval: 5,
        maxInterval: 36000,
        minChange: 200
   ...
   */
  async onAdded() {
    this.log('Soil Moisture Sensor Gen2 has been added');
  }
  ...
  async onRenamed(name) {
    this.log('Soil Moisture Sensor Gen2 Gen2 was renamed');
  }
   ...
   */
  async onDeleted() {
    this.log('Soil Moisture Sensor Gen2 has been deleted');
  }

}

module.exports = soilMoistureSensorGen2;
